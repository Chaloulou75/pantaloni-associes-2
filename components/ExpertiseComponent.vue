<template>
  <div class="min-h-full" id="expertise">
    <h2
      class="sticky top-0 z-30 py-4 text-3xl font-semibold tracking-wider text-center bg-gray-300/50 backdrop-blur"
    >
      Expertise
    </h2>
    <div
      class="items-center justify-between my-8 lg:flex lg:flex-row-reverse lg:px-6"
    >
