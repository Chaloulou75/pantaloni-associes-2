<template>
  <div
    class="relative w-full min-h-screen bg-gradient-to-tr from-blue-500 to-sky-300"
    id="herotop"
  >
    <nuxt-img
      sizes="sm:100vw"
      src="/img/palais1.jpeg"
      alt="palais1"
      class="absolute inset-0 object-cover w-full h-full opacity-20 mix-blend-overlay"
    />
