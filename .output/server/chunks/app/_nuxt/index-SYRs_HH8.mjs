...
const _sfc_main$8 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="absolute inset-0 bg-pink-cabinet/50 mix-blend-overlay backdrop-blur-xxs"></div><div class="mx-auto flex min-h-screen flex-col items-center justify-between"><div class="relative mb-20 mt-auto space-y-8"><h1 class="animate-fade-in-down text-center text-4xl font-normal underline decoration-pink-cabinet decoration-2 underline-offset-8 transition duration-200 md:text-6xl lg:text-8xl"><span class="bg-black bg-clip-text text-transparent"> Pantaloni &amp; Associ\xE9s </span></h1><h2 class="animate-fade-in-down-delai text-center text-3xl font-medium text-black underline decoration-pink-cabinet decoration-2 underline-offset-8 transition duration-200 md:text-4xl lg:text-6xl"> - Avocats \xE0 la Cour - </h2></div><div class="my-20 mr-auto md:mx-auto"><ul class="flex animate-fade-in-down-delai-more flex-col justify-around space-y-3 text-lg font-medium uppercase md:flex-row md:space-x-8 md:space-y-0 lg:text-2xl"><li class="relative cursor-pointer px-3 tracking-wide text-black decoration-pink-cabinet decoration-2 transition duration-300 ease-in-out hover:translate-x-2 hover:underline hover:underline-offset-4"><a href="#cabinet">Le cabinet</a></li><li class="relative cursor-pointer px-3 tracking-wide text-black decoration-pink-cabinet decoration-2 transition duration-300 ease-in-out hover:translate-x-2 hover:underline hover:underline-offset-4"><a href="#equipe">L&#39;equipe</a>`);
      if (unref(showDropdown)) {
        _push(`<div class="absolute z-30 hidden h-auto w-52 rounded-lg bg-gray-50 text-black lg:-top-32 lg:left-5 lg:block"><ul class="divide-y divide-gray-200 px-3 pb-1 pt-2 text-xs"><li class="py-1 hover:font-semibold"><a href="#MarcPantaloni">Marc Pantaloni</a></li><li class="py-1 hover:font-semibold"><a href="#MagaliGreiner">Magali Greiner</a></li><li class="py-1 hover:font-semibold"><a href="#GhinwaRachwan">Ghinwa Rachwan</a></li><li class="py-1 hover:font-semibold"><a href="#SandrineNivetAbdoun">Sandrine Nivet-Abdoun</a></li></ul></div>`);
      } else {
        _push(`<!---->`);
      }
...
function _sfc_ssrRender$5(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({
    ...
    id: "expertise"
  }, _attrs))}><h2 class="sticky top-0 z-30 bg-gray-300/50 py-4 text-center text-xl font-medium uppercase tracking-wider backdrop-blur-xs"> Expertise </h2><div class="relative my-8 h-full items-center justify-between lg:flex lg:flex-row lg:items-start lg:px-6"><div class="w-full lg:sticky lg:top-20 lg:my-36 lg:w-1/2">`);
  _push(ssrRenderComponent(_component_NuxtImg, {
  ...
  _push(`</div><div class="w-full px-4 py-4 text-gray-800 lg:w-1/2 lg:px-8"><div class="mx-auto my-8 w-1/4 border-t border-pink-cabinet"></div><p class="mx-auto py-2 text-justify indent-8 text-xl tracking-wide"> Depuis sa constitution, le Cabinet <span class="font-semibold text-pink-cabinet"> PANTALONI &amp; ASSOCIES </span> propose \xE0 ses clients un accompagnement <span class="font-semibold underline decoration-pink-cabinet decoration-2 underline-offset-2">sur mesure</span> dans ses domaines d\u2019interventions. </p><p class="mx-auto py-2 text-justify indent-8 text-xl tracking-wide"> Le Cabinet dispose d\u2019une comp\xE9tence reconnue en <span class="font-semibold underline decoration-pink-cabinet decoration-2 underline-offset-2">mati\xE8re p\xE9nale</span>, en <span class="font-semibold underline decoration-pink-cabinet decoration-2 underline-offset-2">Droit de la construction</span>, en <span class="font-semibold underline decoration-pink-cabinet decoration-2 underline-offset-2">Droit de la responsabilit\xE9</span> et en <span class="font-semibold underline decoration-pink-cabinet decoration-2 underline-offset-2">Droit des assurances</span>. </p><div class="mx-auto py-6"><ul class="list-inside list-disc space-y-4 text-xl tracking-wide"><li class="font-semibold underline decoration-pink-cabinet decoration-2 underline-offset-2"> Droit de la responsabilit\xE9 civile </li><p class="mx-auto text-justify indent-8 text-xl tracking-wide"> Le Cabinet <span class="font-semibold text-pink-cabinet">PANTALONI &amp; ASSOCIES</span> intervient en <span class="font-semibold"> droit de la responsabilit\xE9 civile des officiers minist\xE9riels</span>, des <span class="font-semibold">agents immobiliers</span> et des <span class="font-semibold">experts judiciaires</span>. </p><p class="mx-auto text-justify indent-8 text-xl tracking-wide"> Par ailleurs, il a d\xE9velopp\xE9 une activit\xE9 en mati\xE8re d\u2019<span class="font-semibold">accidents de la circulation</span> (en application de la Loi Badinter de 1985), ou encore dans le cadre d\u2019<span class="font-semibold">expertises judiciaires</span>, en cas de sinistre de d\xE9g\xE2t des eaux, de d\xE9sordre, ou de malfa\xE7on. </p><li class="font-semibold underline decoration-pink-cabinet decoration-2 underline-offset-2"> Droit de la construction </li><p class="mx-auto text-justify indent-8 text-xl tracking-wide"> Le Cabinet <span class="font-semibold text-pink-cabinet">PANTALONI &amp; ASSOCIES</span> assiste ses clients dans le traitement de l\u2019ensemble des difficult\xE9s survenues en cours de <span class="font-semibold">chantier</span> (sinistre, abandon de chantier, d\xE9sordres, malfa\xE7ons, non-conformit\xE9, litige entreprise, sous-traitant). </p><p class="mx-auto text-justify indent-8 text-xl tracking-wide"> Il assure dans ce cadre le suivi des expertises judiciaires et du contentieux jusqu\u2019au stade de l\u2019ex\xE9cution. </p><li class="font-semibold underline decoration-pink-cabinet decoration-2 underline-offset-2"> Droit p\xE9nal </li><p class="mx-auto text-justify indent-8 text-xl tracking-wide"> Outre le <span class="font-semibold">droit p\xE9nal g\xE9n\xE9ral</span>, le Cabinet <span class="font-semibold text-pink-cabinet">PANTALONI &amp; ASSOCIES</span> intervient en mati\xE8re de <span class="font-semibold">droit p\xE9nal \xE9conomique et des affaires</span>, ainsi qu\u2019en <span class="font-semibold">droit p\xE9nal du travail</span>. </p><p class="mx-auto text-justify indent-8 text-xl tracking-wide"> Ce faisant, il assiste tant les entreprises que les particuliers, qu\u2019ils soient <span class="font-semibold">pr\xE9venus</span> ou <span class="font-semibold">parties civiles</span>, \xE0 tous les stades de la proc\xE9dure. </p><li class="font-semibold underline decoration-pink-cabinet decoration-2 underline-offset-2"> Droit des assurances </li><p class="mx-auto text-justify indent-8 text-xl tracking-wide"> Le Cabinet <span class="font-semibold text-pink-cabinet">PANTALONI &amp; ASSOCIES</span> intervient dans la gestion des litiges susceptibles de na\xEEtre d\u2019un <span class="font-semibold">contrat d\u2019assurance</span> (assurance responsabilit\xE9, assurance construction, assurance voiture). </p><p class="mx-auto text-justify indent-8 text-xl tracking-wide"> Il met en jeu les <span class="font-semibold">garanties l\xE9gales</span>: garantie de parfait ach\xE8vement, garantie d\xE9cennale, garantie biennale ainsi que les <span class="font-semibold">responsabilit\xE9s de droit commun</span>: contractuelle et d\xE9lictuelle outre les responsabilit\xE9s sp\xE9cifiques (fabricant, vendeur, fournisseur). </p></ul></div><div class="mx-auto my-8 w-1/4 border-t border-pink-cabinet"></div></div></div></div>`);
}
...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({
    class: "h-auto py-20",
    id: "MarcPantaloni"
  }, _attrs))}><h2 class="mb-4 py-2 text-center text-4xl font-normal text-gray-800 lg:text-5xl"> Marc Pantaloni </h2><div class="mx-auto my-8 w-1/4 border-t border-pink-cabinet"></div><div class="lg:flex lg:items-center lg:justify-between"><div class="w-full lg:w-1/2">`);
  _push(ssrRenderComponent(_component_NuxtImg, {
  ...
  _push(`</div><div class="mt-4 flex w-full flex-col justify-between px-4 py-4 text-gray-800 lg:mt-0 lg:w-1/2 lg:pr-12"><ul class="mb-5 list-inside list-disc space-y-4 px-2 pt-2 text-justify text-xl font-medium italic tracking-wide"><li class="not-italic"> Inscrit au Barreau de Paris depuis janvier 1983 </li><li> Ancien Secr\xE9taire de la Conf\xE9rence au Barreau de Paris (1986/1987) </li><li>Ancien charg\xE9 d\u2019enseignement \xE0 l\u2019Universit\xE9 Paris XI</li><li>DEA droit des affaires (Universit\xE9 Panth\xE9on-Assas Paris II)</li></ul><div class="h-full w-full space-y-4 px-2 text-justify text-xl font-medium tracking-wide text-gray-800"><p class="indent-8"> Associ\xE9 au sein du Cabinet RONSSERAY TOURNOIS &amp; ASSOCIES, puis membre fondateur du Cabinet SELNET PANTALONI FISCHER, <span class="font-bold text-pink-cabinet">Marc PANTALONI</span> a constitu\xE9 une \xE9quipe d\xE9di\xE9e au service de clients auxquels sont apport\xE9s tant la formation \xE0 raison de s\xE9minaires d\xE9di\xE9s que le conseil, l\u2019assistance pr\xE9-contentieuse et contentieuse qui leur est n\xE9cessaire. </p><p class="indent-8"> En mati\xE8re p\xE9nale, Marc PANTALONI est intervenu et intervient dans de nombreux dossiers \xE0 forts enjeux tant en droit p\xE9nal des affaires et financiers qu\u2019en droit p\xE9nal g\xE9n\xE9ral et du travail. </p><p class="indent-8"> Son activit\xE9 se d\xE9ploie en outre dans les domaines de la construction et de l\u2019immobilier o\xF9 il intervient aux c\xF4t\xE9s d\u2019entreprises de BTP ou de leurs assureurs. </p><p class="indent-8"> Enfin, il assure dans le cadre de leurs responsabilit\xE9s civiles professionnelles et/ou contractuelles la d\xE9fense d\u2019agents immobiliers et des professionnels du droit, notamment notaires, experts judiciaires\u2026 </p></div><div class="mx-auto my-8 w-1/4 border-t border-pink-cabinet"></div></div></div></div>`);
}
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({
    class: "h-auto py-20",
    id: "MagaliGreiner"
  }, _attrs))}><h2 class="mb-4 py-2 text-center text-4xl font-normal text-gray-800 lg:text-5xl"> Magali Greiner </h2><div class="mx-auto my-8 w-1/4 border-t border-pink-cabinet"></div><div class="lg:flex lg:flex-row-reverse lg:items-center lg:justify-between"><div class="w-full lg:w-1/2">`);
  _push(ssrRenderComponent(_component_NuxtImg, {
    sizes: "sm:95vw md:50vw lg:400px",
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({
    class: "h-auto py-20",
    id: "GhinwaRachwan"
  }, _attrs))}><h2 class="mb-4 py-2 text-center text-4xl font-normal text-gray-800 lg:text-5xl"> Ghinwa Rachwan </h2><div class="mx-auto my-8 w-1/4 border-t border-pink-cabinet"></div><div class="lg:flex lg:items-center lg:justify-between"><div class="w-full lg:w-1/2">`);
  _push(ssrRenderComponent(_component_NuxtImg, {
    sizes: "sm:95vw md:50vw lg:400px",
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  }, _attrs))}><h2 class="mb-4 py-2 text-center text-4xl font-normal text-gray-800 lg:text-5xl"> Sandrine Nivet-Abdoun </h2><div class="mx-auto my-8 w-1/4 border-t border-pink-cabinet"></div><div class="lg:flex lg:flex-row-reverse lg:items-center lg:justify-between"><div class="w-full lg:w-1/2">`);
  _push(ssrRenderComponent(_component_NuxtImg, {
    sizes: "sm:95vw md:50vw lg:400px",
  ...
  _push(`</div><div class="mt-4 flex w-full flex-col justify-between px-4 py-4 text-gray-800 lg:mt-0 lg:w-1/2 lg:pl-12"><ul class="mb-5 list-inside list-disc space-y-4 px-2 pt-2 text-justify text-xl font-medium italic tracking-wide"><li> Titulaire d\u2019un MASTER 2 Recherche, Sciences Sociales de la Justice, apr\xE8s un MASTER 1 de Droit des Affaires (Mention Justice et Proc\xE8s). </li></ul><div class="h-full w-full space-y-4 px-2 text-justify text-xl font-medium tracking-wide text-gray-800"><p class="indent-8"> Juriste confirm\xE9e, <span class="font-bold text-pink-cabinet">Sandrine NIVET-ABDOUN</span> a rejoint le Cabinet d\xE8s sa constitution. </p><p class="indent-8"> Elle assure une fonction de support et de coordination tant \xE0 l\u2019\xE9gard des clients qu\u2019aupr\xE8s des juridictions. </p><p class="indent-8"> Elle est en outre en charge du bon suivi de l\u2019ex\xE9cution de l\u2019ensemble des d\xE9cisions judiciaires rendues. </p></div><div class="mx-auto my-8 w-1/4 border-t border-pink-cabinet"></div></div></div></div>`);
}
...
//# sourceMappingURL=index-SYRs_HH8.mjs.map
