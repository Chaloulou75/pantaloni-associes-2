...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./_nuxt/index-SYRs_HH8.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./_nuxt/mentionslegales-3aA-HH6s.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./_nuxt/error-404-wZrU12ol.mjs').then((r) => r.default || r));
...
export { _export_sfc as _, useRuntimeConfig as a, useNuxtApp as b, createError as c, useRouter as d, entry$1 as default, navigateTo as e, injectHead as i, nuxtLinkDefaults as n, resolveUnrefHeadInput as r, useRequestEvent as u };
